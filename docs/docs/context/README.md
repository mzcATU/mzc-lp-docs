...
| [design.md](./design.md) | 디자인 시스템, Figma MCP | ~180 | UI 구현, 스타일링시 |
| [infrastructure.md](./infrastructure.md) | AWS, Docker, 배포 환경 | ~230 | 인프라 설정, 배포시 |
| [multi-tenancy.md](./multi-tenancy.md) | SaaS 멀티테넌시 아키텍처 | ~235 | 테넌트 기능 개발시 |
...
### 멀티테넌시 작업시
```
1. multi-tenancy.md  → 구조/역할 파악
2. 24-MULTI-TENANCY  → 구현 코드 패턴 (conventions/)
```
